...
const ApplicationItem = ({
  ...
  const getAvatarUrl = () => {
    if (isGroup) {
      return isRecv ? getResourceUrl(source.userFaceURL) : getResourceUrl(source.groupFaceURL);
    }
    return isRecv ? getResourceUrl(source.fromFaceURL) : getResourceUrl(source.toFaceURL);
  };
